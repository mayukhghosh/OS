public class PRA{
    ...
    public void execute(int process,int page)
    {
        ...
        Main.frame_table[index].eviction_time=Main.global_time;
		...
		Main.list[Main.frame_table[index].process_num-1].residency_time=Main.list[Main.frame_table[index].process_num-1].residency_time+Main.frame_table[index].eviction_time-Main.frame_table[index].loaded_time;
		...
		//System.out.println("Eviction Time: "+Main.frame_table[index].eviction_time+" Loaded time: "+Main.frame_table[index].loaded_time);
        ...
        Main.frame_table[index].loaded_time=Main.global_time;
